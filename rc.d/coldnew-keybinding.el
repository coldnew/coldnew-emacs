...
(global-set-key  (kbd "C-w f") 'fullscreen-window)
...
(global-set-key  (kbd "C-w C-f") 'fullscreen-window)
(global-set-key  (kbd "C-w C-j") 'windmove-down-fullscreen)
(global-set-key  (kbd "C-w C-h") 'windmove-left-fullscreen)
(global-set-key  (kbd "C-w C-l") 'windmove-right-fullscreen)
(global-set-key  (kbd "C-w C-k") 'windmove-up-fullscreen)
(global-set-key  (kbd "C-w C-v") 'split-window-vertically)
(global-set-key  (kbd "C-w C-h") 'split-window-horizontally)
(global-set-key  (kbd "C-w C-n") 'make-frame)
(global-set-key  (kbd "C-w C-d") 'delete-frame)
(global-set-key  (kbd "C-w C-o") 'other-frame)
(global-set-key  (kbd "C-w C-a") 'delete-other-frames)
(global-set-key  (kbd "C-w C-s") 'sr-speedbar-toggle)
