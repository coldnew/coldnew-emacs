...
#+begin_src emacs-lisp
  '(magit-item-highlight ((t (:background "#0B0B0E" :foreground "#DCDCDC"))))
#+end_src
*** woman
...
;;  (evil:nmap (kbd "C-f") 'evil-forward-char)
;;  (evil:nmap (kbd "C-b") 'evil-backward-char)
#+end_src
...
** TODO 位龜類
#+begin_src emacs-lisp
  (setq auto-save-visited-file-name nil)    ; auto-save buffer in the file it is visiting
