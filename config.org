...
#+BEGIN_SRC emacs-lisp
  (setq blogit-source-dir "~/SparkleShare/blog-src")
  (setq blogit-output-dir "~/SparkleShare/coldnew.github.io/blog-new")
  ...
  (setq blogit-site-url "http://coldnew.github.com")

  (setq blogit-sanitize-length 5)
