...
#+begin_src emacs-lisp
  (setq-default el-get-dir (concat emacs-dir "lisp"))
#+end_src
...
#+begin_src emacs-lisp
  ...
  ;; ensures that any currently installed packages will be initialized
...
#+begin_src emacs-lisp
  (add-to-list 'el-get-recipe-path (concat emacs-dir "recipes"))
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (defmacro require* (feature &rest body)
    ...
    `(let* ((BODY ',body)
            (HASBODY (not (null BODY))))
       (unless (require ,feature nil 'noerror)
         (if HASBODY
             (eval `(req-package ,,feature ,,@body))
           (eval `(req-package ,,feature)))
         ;; Make req-package install missing one
         (req-package-finish))))
#+END_SRC
