...
#+begin_src emacs-lisp
  (defun coldnew/update-blog ()
    (interactive)
    (shell-command "cd ~/Workspace/WriteOnce/Blog; git rm -rf *" nil nil)
    (org-publish-blog coldnew-blog-org-file)
    (shell-command "cd ~/Workspace/WriteOnce/Blog; git add . ; git commit -m 'update blog'" nil nil)
    (shell-command "cd ~/Workspace/WriteOnce/Blog; git push " nil nil)
    (firefox-refresh))
#+end_src
* Local File Variable
# Local Variables:
