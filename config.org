...
#+begin_src emacs-lisp
  (setq erc-autojoin-channels-alist
        '(
          ;; english channel
          (".*\\.freenode.net" "#emacs" "#clojure" "##linux" "#yocto" "#ubuntu-touch" "#qt")
          (".*\\.mozilla.org" "#b2g")
          ;; Chinese channel
          (".*\\.freenode.net" "#emacs.tw" "#tossug" "#coscup" "#g0v.tw")
          (".*\\.oftc.net" "#dot")))
#+end_src
  ...
  (setq coldnew/mu4e-account-alist
        '(("Gmail"
          ...
          ("Weintek"
           ...
           (smtpmail-smtp-server "www.hibox.hinet.net")
           (smtpmail-smtp-service 587)
           (smtpmail-smtp-user "yenchin@weintek.com")
           (user-full-name "李彥瑾")
           (mu4e-compose-signature
            "Best regards,
  研發一處  李彥瑾(yenchin)
  Website: www.weintek.com
  傳真號碼: (886)2-22286771 / 連繫電話: (886)2-22286770
  新北市 23586 中和區中正路 910 號 9 樓"))
          ))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (define-key minibuffer-local-map (kbd "M-s") (lambda () (interactive) (kill-line 0) (insert "~/Copy/")))
#+end_src
...
| 快速命令 | M-4     | switch-to-irc            | 切換到 IRC 緩衝區                  |
...
| 緩衝區   | C-x M-e | erc-iswitchb             | 切換到 IRC 緩衝區                  |
