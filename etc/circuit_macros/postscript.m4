...
command "/white {1 1 1} def /grey {0.5 0.5 0.5} def /black {0 0 0} def"
command "/lightgrey {0.75 0.75 0.75} def /darkgrey {0.25 0.25 0.25} def"
command "/red {1 0 0} def /green {0 1 0} def /blue {0 0 1} def"
command "/cyan {0 1 1} def /magenta {1 0 1} def /yellow {1 1 0} def"')
