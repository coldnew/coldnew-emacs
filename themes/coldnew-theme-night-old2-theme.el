...
;;; Code:
(require 'coldnew-theme-old2)

(deftheme coldnew-theme-night-old2
...
(coldnew-theme--with-colors-old2
  'night
  (apply 'custom-theme-set-faces 'coldnew-theme-night-old2
         (coldnew-theme--face-specs-old2))
  (custom-theme-set-variables
   'coldnew-theme-night-old2
   `(ansi-color-names-vector (vector ,foreground ,red ,green ,yellow ,blue ,magenta ,cyan ,background))
   '(ansi-color-faces-vector [default bold shadow italic underline bold bold-italic bold])))

;;;###autoload
(defun coldnew-theme-night-old2 ()
  (interactive)
  (coldnew-theme--load-theme-old2 'night))

(provide 'coldnew-theme-night-old2-theme)
