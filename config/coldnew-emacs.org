...
#+end_src
**** Crypt
用於加密 org-mode 特定區塊。注意到這需啟用 [[*Easy%20PG][Easy PG]] 才能夠使用。
#+begin_src emacs-lisp
  (require 'org-crypt)
...
jA0EAwMCoq7+oQBCa5VgyVGwlwdGEw27kQwTkRk0Hoo62iLCiKhbDIfatd2EWhYB
kD4C3D2bpOgmcM407PHllHuagsCOypKrnkEMeZnGbZRrWUlwM07DWv3ZANnFjgYV
NUI=
=6SZt
-----END PGP MESSAGE-----
* Alias                                                               :alias:
