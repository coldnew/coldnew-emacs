;;; show-paren-region.el ---

;; Copyright 2011 Yen-Chin,Lee
;;
;; Author: coldnew coldnew.tw@gmail.com
;; Keywords:
;; X-URL: http://www.emacswiki.org/cgi-bin/wiki/download/show-paren-region.el
(defconst show-paren-region-version "0.1")
...
;;; Bug Report:
;;
;; If you have problems, send a bug report via M-x show-paren-region-send-bug-report.
...
;;  3) Use Lisp version instead of compiled one: (load "show-paren-region.el")
;;  4) Do it!
;;  5) If you got an error, please do not close *Backtrace* buffer.
;;  6) M-x show-paren-region-send-bug-report (outside)
...
(provide 'show-paren-region)
;; show-paren-region.el ends here.
