...
PUB-DIR is set, use this as the publishing directory."
  ...
  (setq old-org-export-html-style org-export-html-style)
  (setq old-org-export-html-style-extra org-export-html-style-extra)
...
<!--
layout: [layout-regular|layout-faux-widescreen|layout-widescreen]
-->
%s
"
		 title
...
%s
	...
	(org-html5presentation-open-par))
      ...
      (when (and (> umax 0) first-heading-pos) (insert "</article>\n"))
...
"))
	...
	(while (setq beg (next-single-property-change (point) 'org-whitespace))
      ...
      (setq org-export-html-style old-org-export-html-style)
      (setq org-export-html-style-extra old-org-export-html-style-extra)
  ...
  (let* ((target (and title (org-get-text-property-any 0 'target title)))
    ...
    (when title
      ...
      (if (> level umax)
            ...
            (setq title (concat
                         (format "<span class=\"section-number-%d\">%s</span>"
                                 ...
                                 (if (and num
                                   ...
                                   ""))
                         " " title)))
        (unless (= head-count 1) (insert "</article>\n"))
        ...
        (setq class "smaller nobackground")
        (insert
         (concat "<article"
