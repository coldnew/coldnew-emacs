...
;; Keywords:
;; X-URL: http://www.emacswiki.org/cgi-bin/wiki/download/gambit-mode.el
(defconst gambit-mode-version "0.1")
...
;;; Bug Report:
;;
;; If you have problems, send a bug report via M-x gambit-mode-send-bug-report.
...
;;  3) Use Lisp version instead of compiled one: (load "gambit-mode.el")
;;  4) Do it!
;;  5) If you got an error, please do not close *Backtrace* buffer.
;;  6) M-x gambit-mode-send-bug-report (outside)
